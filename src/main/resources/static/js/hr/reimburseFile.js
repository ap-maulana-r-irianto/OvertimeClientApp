...
function create() {
    ...
    formData.append('nominal', $('#reimburse-in-nominal').val());
    formData.append('description', $('#reimburse-in-description').val());
    formData.append('status', $('#reimburse-in-status').val());
    formData.append('employee', $('.reimburse-in-employee').val());
    formData.append('type', $('.reimburse-in-type').val());
    formData.append('file', $('#reimburse-in-file')[0].files[0]);
    $.ajax({
        method: "POST",
        url: "api/reimburse",
        dataType: "JSON",
...
function update() {
    ...
    let valFile = $('#reimburse-up-file')[0].files[0]
    let valStatus = $('#reimburse-up-status').val()
    let valEmployee = $('.reimburse-in-employee').val()
    let valType = $('.reimburse-in-type').val()

    let formData = new FormData()
    formData.append('nominal', valNominal)
    formData.append('description', valDescription)
    formData.append('file', valFile)
    formData.append('status', valStatus)
    formData.append('employee', valEmployee)
    formData.append('type', valType)
